    \begin{spacing}{1.5}
        ...
        Pour répondre à cette problématique, ce mémoire s'intitule : « RESTRUCTURATION DU BACKEND D'UNE PLATEFORME E-COMMERCE : TRANSITION D'UN MONOLITHE VERS UNE ARCHITECTURE MICROSERVICES ». Son objectif est de migrer une architecture monolithique existante vers une architecture basée sur des microservices en utilisant des méthodologies et des techniques modernes de développement logiciel.
