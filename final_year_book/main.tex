...
\usepackage{etoolbox}
\BeforeBeginEnvironment{verbatim}{\par\addvspace{0.5em}\noindent\begin{minipage}{\linewidth}\setstretch{0.9}}
\AfterEndEnvironment{verbatim}{\end{minipage}\par\addvspace{0.5em}}
...
%         UI & User Interface \\
    ...
    \input{section/glossaire.tex}
    \input{section/liste_tableau.tex}
    \input{section/liste_figure.tex}
